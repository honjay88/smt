...
console.log('ccccccccccccccccccc');
        ...
        this.hubProxy.on("onEvent", (channel: string, ev: ChannelEvent) => {
         ...
         this.hubProxy.on('messageReceived', (latestMsg) => this.onMessageReceived(latestMsg));
   ...
   //      this.broadcastMessage('fuck'); 


         this.starting$.subscribe(() => {
             console.log('login sub Subscribe channel');
            this.hubProxy.invoke("sendMessage", 'fuck')
                .done(() => {
                    console.log(`Successfully subscribed to fuck`);
                })
                .fail((error: any) => {
            ...
            (error: any) => {
                    console.log('error sub Subscribe channel');
               // channelSub.subject.error(error);
            });
        ...
        console.log('login sub Subscribe');
        console.log(this.starting$);
        this.starting$.subscribe(() => {
             console.log('login sub Subscribe channel'+channel);
            ...
            (error: any) => {
                    console.log('error sub Subscribe channel'+channel);
                channelSub.subject.error(error);
            });
    ...
    broadcastMessage(msg: string) {
        ...
        this.hubProxy.invoke('sendMessage', msg);
    }
}